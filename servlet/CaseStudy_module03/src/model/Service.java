...
public class Service {
    ...
    public Service(int serviced_id, String service_name, double service_area, double service_cost, int service_max_people, int rent_type_id, int service_type_id, String standard_room, String description_other_convenience, double pool_area, int number_of_floors) {
        this.serviced_id = serviced_id;
    ...
    public int getServiced_id() {
        return serviced_id;
    }

    public void setServiced_id(int serviced_id) {
        this.serviced_id = serviced_id;
    }
